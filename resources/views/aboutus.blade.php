            ...
            <div class="container">
                <div class="row" style="text-align: center; margin-top: 120px;" >
                    <section style="text-justify: auto">
                        ...
                        <p>Zespół Odlot.pl to strona internetowa która zrewolucjonizowała rynek kupna biletów lotniczych. Już w pierszym dniu naszej pracy odwiedziło nas ponad 10 tysięcy klientów. Projekt jest nadal rozwijany i testowane są coraz większe możliwości</p> <br> <br>
                ...
                <div class="row " style="font-size: 40px; font-family: 'Bradley Hand ITC'; margin-top: 50px;">
                    <div class="col">
                        Jestem biznesmenem a jak na człowieka biznesu przystało duzo podrozuje. Od zawsze miałem problem z wygodnym bookowaniem biletów, ale teraz jest to przeszlosc.
                        <p style="font-family: Bahnschrift">- Jan Kowalski</p>
                    </div>
                    <div class="col">
                        Jest to serwis wysokich lotow, doslownie! Oprocz wygodnego kupna, klient od razu ma dostep do historii biletow za jednym kliknieciem. Kupowanie biletow nigdy nie bylo tak proste!
                        <p style="font-family: Bahnschrift">- Andrzej Nowak</p>
                    </div>
                    <div class="col">
                        Projekt ten postawił wysoko poprzeczke innym serwisom działajacym w tej branzy. Zostaly wykorzystane najnowsze technologie, jest bezpieczny i szybki!
